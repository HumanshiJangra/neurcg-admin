    ...
    <div>
      ...
      <div className="text-right mt-4">
        <ReactPaginate
          ...
          containerClassName={'inline-flex mt-[34px] bg-[#F5F6F8] rounded-[5px] border border-[#eb823c0f]'}
          pageClassName={'text-[#6B6B6B] '}
          pageLinkClassName={'py-2 px-4 inline-block'}
          activeClassName={'bg-[#E87223] rounded-[5px] text-white'}
          previousLinkClassName={'py-2 px-4 h-full flex items-center'}
          nextLinkClassName={'py-2 px-4 h-full flex items-center '}
